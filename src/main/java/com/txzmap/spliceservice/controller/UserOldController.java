...
//        UserOld userOld = tbUserService.get(userName, password);
//
//
//        if (userOld == null)
...
//        if (userOld.getUserName().equals("test")) {
...
//        }
//
//        if (userOld.getPassword().equals(nowPassword)) {
//            tbUserService.changePassword(userOld.getUserName(), newPassword);
...
//        UserOld userOld = (UserOld) session.getAttribute("userOld");
//
//        resultMap.put("userName", userOld.getUserName());
//        resultMap.put("createTime", sdf.format(userOld.getCreateTime()));
//        resultMap.put("expiration", sdf.format(userOld.getExpiration()));
        return resultMap;
    }
